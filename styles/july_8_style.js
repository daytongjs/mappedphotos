...
var style_july_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        function rules_july_8(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_july_8rule0_eval_expression(context)) {
        ...
        var style = rules_july_8(feature, value);
        ;

...
var style_august_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        function rules_august_9(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_august_9rule0_eval_expression(context)) {
        ...
        var style = rules_august_9(feature, value);
        ;
